...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/CV4VI_Gajah_Mada\TexturesWIP\gajah_skin_blur.DDS"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1853716854</m_ExportedTime>
	<m_ClassName text="Leader_BlurWidth"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="gajah_skin_blur.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="gajah_skin_blur"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
