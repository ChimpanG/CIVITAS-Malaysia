...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="\\WDMYCLOUD\Sam\Projects\Modding\Civ VI\Civilizations\Malaysia\Assets\Lancaran\Textures\Malay_Lancaran_ao.tga"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3045751079</m_ExportedTime>
	<m_ClassName text="Generic_AO"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Malay_Lancaran_ao.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Malay_Lancaran_ao"/>
	<m_Description text=""/>
	<m_Tags/>
	<m_Groups/>
</AssetObjects..TextureInstance>
